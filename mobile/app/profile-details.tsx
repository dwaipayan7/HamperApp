                                ...
                                <View key={index}>
                                    ...
                                    >
                                        ...
                                        <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                                            ...
                                            {/* <FontAwesome style={{
                                                marginTop: 16
                                            }} onPress={() => { }} size={30} color={COLORS.white} name='comment' /> */}
                                        </View>
                                    ...
                                    <TouchableOpacity
                                        ...
                                        activeOpacity={0.8}
                                        style={{ flexDirection: 'row', alignItems: 'center', gap: 5, justifyContent: 'center', paddingVertical: 12, marginHorizontal: 12, backgroundColor: COLORS.lightBlue, borderRadius: 28, marginTop: 12 }}>
                                        <MaterialIcons
                                            name="send"
                                            color={COLORS.white}
                                            size={18}
                                        ...
                                        />
                                        <SCText varient='bold' color={COLORS.white} >Message</SCText>
                                    </TouchableOpacity >
